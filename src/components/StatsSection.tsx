...
const stats = [
  { icon: Users, value: 1658, suffix: "+", label: "Happy Customers" },
  { icon: PenSquare, value: 92, suffix: "+", label: "Project Complete" },
  { icon: BadgeCheck, value: 184, suffix: "+", label: "Registered Member" },
  { icon: Award, value: 2, suffix: "+", label: "Awards Winning" },
];
