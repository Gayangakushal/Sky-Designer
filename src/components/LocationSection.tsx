        ...
        <div className="grid lg:grid-cols-3 gap-8 items-stretch">
          ...
          >
            <div className="glass-card p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Kanatta Rd, Battaramulla 10120</p>
              </div>
            </div>
          ...
          >
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.9!2d79.918!3d6.9!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwNTQnMDAuMCJOIDc5wrA1NScwNC44IkU!5e0!3m2!1sen!2slk!4v1700000000000"
              width="100%"
              height="100%"
              style={{ border: 0, minHeight: 350, filter: "invert(90%) hue-rotate(180deg) brightness(0.8) contrast(1.2)" }}
              allowFullScreen
              loading="lazy"
